                ...
                <div className="container py-4 py-lg-5">
                    <ul className="list-inline">
                        <li className="list-inline-item me-4">
                            <a href='https://www.facebook.com/MsCrystalDavila/'>
                        ...
                        <li className="list-inline-item me-4">
                            <a href='https://www.linkedin.com/in/crysforpasadena'>
                        ...
                        <li className="list-inline-item">
                            <a href='https://www.instagram.com/crysforpasadena/'>
                    ...
                    <p className="mb-0">© 2025 Crystal Dávila</p>
                </div>
            </footer>
        </section>
    )
